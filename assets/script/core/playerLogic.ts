...
import { _decorator, Component, Node, Vec3, Prefab, Quat, ModelComponent, geometry, Mat4, math, ColliderComponent } from 'cc';
...
export class PlayerLogic extends Component {
    ...
    protected start (): void {
        ColliderManager.instance.buildCollider(this.obstacleGroupNode);
    }
